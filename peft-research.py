...
def test_compute_metrics():
    # Mock logits (simulating model predictions)
    logits = np.array([
        [2.1, 0.3, 0.2],  # Predicts class 0
        [0.1, 1.5, 0.9],  # Predicts class 1
        [0.4, 0.2, 3.2],  # Predicts class 2
        [1.2, 2.4, 0.5],  # Predicts class 1
        [3.1, 0.2, 0.8]   # Predicts class 0
    ])
